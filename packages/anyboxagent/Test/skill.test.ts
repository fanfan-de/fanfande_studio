...
describe("skill discovery", () => {
  ...
  beforeEach(async () => {
    projectRoot = await mkdtemp(join(tmpdir(), "anybox-skill-project-"))
    fakeHome = await mkdtemp(join(tmpdir(), "anybox-skill-home-"))
...
describe("global skill folder management", () => {
  ...
  beforeEach(async () => {
    fakeHome = await mkdtemp(join(tmpdir(), "anybox-skill-manager-home-"))
...
describe("git skill install", () => {
  ...
  beforeEach(async () => {
    fakeHome = await mkdtemp(join(tmpdir(), "anybox-skill-git-home-"))
    previewRoot = await mkdtemp(join(tmpdir(), "anybox-skill-git-preview-"))
